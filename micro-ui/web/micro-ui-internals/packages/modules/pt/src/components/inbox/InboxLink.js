...
const InboxLinks = ({ parentRoute, businessService }) => {
  ...
  const allLinks = [
    {
     // text: "ES_TITLE_NEW_REGISTRATION",
      text: "New Pet Registration",     // change the localization name 
  ...
  const GetLogo = () => (
    <div className="header">
      ...
      <span className="text">{t("Pet Registration")}</span>      {/*  change it to the localization name which is set in the above text */ }
    </div>
  );
